Page({
  data: {
    ...
    // 筛选
    array: [{ name: '小户型50平以下' }, { name: '中户型50-100平' }, { name: '大户型100以上' }],
    chaoxiang: [{ name: '朝南' }, { name: '朝东' }, { name: '朝西' }, { name: '朝北' }],
    louceng: [{ name: '低层1-7楼' }, { name: '中层7-15楼' }, { name: '高层15楼以上' }],
    zhuangxiu: [{ name: '精装' }, { name: '简装' }, { name: '毛胚' }, { name: '豪华' }],
    leibei: [{ name: '排屋' }, { name: '别墅' }, { name: '商品房' }, { name: '自建房' }],
